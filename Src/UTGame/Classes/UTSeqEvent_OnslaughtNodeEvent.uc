...
function NotifyNodeChanged(Controller EventInstigator)
{
	...
	if (Node == None)
	{
		WarnInternal("No Onslaught Node connected to" @ self);
	}
	else
	{
...
defaultproperties
{
   ...
   VariableLinks(1)=(ExpectedType=Class'Engine.SeqVar_Object',LinkDesc="Node Team's PowerCore",bWriteable=True,MinVars=1,MaxVars=255)
   ObjClassVersion=2
   ObjName="Onslaught Node Event"
   ObjCategory="Objective"
   Name="Default__UTSeqEvent_OnslaughtNodeEvent"
