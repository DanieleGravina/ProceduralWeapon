...
defaultproperties
{
   ...
   CategoryNames(0)=(Category="Order",FriendlyName="Ordini")
   CategoryNames(1)=(Category="Taunt",FriendlyName="Cattivi")
   CategoryNames(2)=(Category="Status",FriendlyName="Stato")
