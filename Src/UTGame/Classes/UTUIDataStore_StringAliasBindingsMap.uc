...
defaultproperties
{
   ...
   MenuInputMapArray(38)=(FieldName="GBA_TriggerHero")
   MenuInputMapArray(39)=(FieldName="GBA_GrowHud")
   MenuInputMapArray(40)=(FieldName="GBA_ShrinkHud")
   MenuInputMapArray(41)=(FieldName="GBA_ToggleMelee")
   MenuInputMapArray(42)=(FieldName="GBA_WeaponPicker")
   MenuInputMapArray(43)=(FieldName="GBA_Jump_Gamepad")
   MenuInputMapArray(44)=(FieldName="GBA_MoveForward_Gamepad")
   MenuInputMapArray(45)=(FieldName="GBA_TurnLeft_Gamepad")
   MenuInputMapArray(46)=(FieldName="GBA_Use_Gamepad")
   Tag="StringAliasBindings"
   Name="Default__UTUIDataStore_StringAliasBindingsMap"
