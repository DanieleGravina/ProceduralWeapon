...
defaultproperties
{
   ...
   VariableLinks(1)=(ExpectedType=Class'Engine.SeqVar_Object',LinkDesc="New Base",PropertyName="NewBase",MinVars=1,MaxVars=1)
   ObjName="Change Orb Base"
   ObjCategory="Objective"
   Name="Default__UTSeqAct_ChangeOrbBase"
