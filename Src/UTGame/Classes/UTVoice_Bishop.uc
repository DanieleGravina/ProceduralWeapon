...
defaultproperties
{
   ...
   TauntAnimSoundMap(0)=(EmoteTag="TauntA",TauntSoundIndex=(0,2,9,11,17))
   TauntAnimSoundMap(1)=(EmoteTag="TauntB",TauntSoundIndex=(5,13))
   TauntAnimSoundMap(2)=(EmoteTag="TauntC",TauntSoundIndex=(14))
   TauntAnimSoundMap(3)=(EmoteTag="TauntD",TauntSoundIndex=(4,7,12,15))
   TauntAnimSoundMap(4)=(EmoteTag="TauntE",TauntSoundIndex=(3,6,16))
   TauntAnimSoundMap(5)=(EmoteTag="TauntF",TauntSoundIndex=(1,8,10))
   Name="Default__UTVoice_Bishop"
