...
defaultproperties
{
   ...
   TauntAnimSoundMap(0)=(EmoteTag="TauntA",TauntSoundIndex=(1,12,16,22))
   TauntAnimSoundMap(1)=(EmoteTag="TauntB",TauntSoundIndex=(4,5,17))
   TauntAnimSoundMap(2)=(EmoteTag="TauntC",TauntSoundIndex=(3,9,16,20))
   TauntAnimSoundMap(3)=(EmoteTag="TauntD",TauntSoundIndex=(13,8,11,18))
   TauntAnimSoundMap(4)=(EmoteTag="TauntE",TauntSoundIndex=(7,10,15,19))
   TauntAnimSoundMap(5)=(EmoteTag="TauntF",TauntSoundIndex=(2,6,14,21))
   Name="Default__UTVoice_DefaultMale"
