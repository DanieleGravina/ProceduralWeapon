...
defaultproperties
{
   ...
   TauntAnimSoundMap(0)=(EmoteTag="TauntA",TauntSoundIndex=(1,4,6,15,25))
   TauntAnimSoundMap(1)=(EmoteTag="TauntB",TauntSoundIndex=(3,7,14,27))
   TauntAnimSoundMap(2)=(EmoteTag="TauntC",TauntSoundIndex=(2,5,16,29))
   TauntAnimSoundMap(3)=(EmoteTag="TauntD",TauntSoundIndex=(8,9,22,28))
   TauntAnimSoundMap(4)=(EmoteTag="TauntE",TauntSoundIndex=(10,11,13,17,32,33))
   TauntAnimSoundMap(5)=(EmoteTag="TauntF",TauntSoundIndex=(0,12,18,29))
   LocationSpeechOffset=2
   Name="Default__UTVoice_Othello"
