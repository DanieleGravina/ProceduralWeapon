...
private function PromptForServerPassword()
{
	...
	{
		LogInternal("Failed to open the input box scene (" $ InputBoxScene $ ")");
	}
}
...
private function ProcessFollow()
{
	...
	if(PlayerInt != None)
	{
		LogInternal("UTUIScene_PlayerCard::OnFollow() - Joining friend's game...");
...
{
	LogInternal("UTUIScene_PlayerCard::OnJoiningMessage_Closed() - bWasAbleToJoin:"@bWasAbleToJoin);
