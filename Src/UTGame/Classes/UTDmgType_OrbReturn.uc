...
defaultproperties
{
   DeathString="`o ha deciso di essere un eroe."
   FemaleSuicide="`o ha deciso di essere un'eroina."
   MaleSuicide="`o ha deciso di essere un eroe."
   Name="Default__UTDmgType_OrbReturn"
