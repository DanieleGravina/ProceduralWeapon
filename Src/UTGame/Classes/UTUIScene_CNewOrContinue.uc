...
defaultproperties
{
   ...
   OptionDescriptions(0)="<Strings:UTGameUI.Campaign.CampaignStartNew_Desc>"
   OptionDescriptions(1)="<Strings:UTGameUI.Campaign.CampaignContinue_Desc>"
   OptionDescriptions(2)="<Strings:UTGameUI.Campaign.CampaignOnline_Desc>"
   OptionDescriptions(3)="<Strings:UTGameUI.Campaign.CampaignChapter_Desc>"
   OptionDescriptions(4)="<Strings:UTGameUI.Campaign.CampaignOnlineLan_Desc>"
   ...
   Name="Default__UTUIScene_CNewOrContinue"
