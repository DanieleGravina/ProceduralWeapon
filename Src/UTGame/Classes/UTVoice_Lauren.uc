...
defaultproperties
{
   ...
   TauntAnimSoundMap(0)=(EmoteTag="TauntA",TauntSoundIndex=(2,6,9,16,22))
   TauntAnimSoundMap(1)=(EmoteTag="TauntB",TauntSoundIndex=(1,14,19))
   TauntAnimSoundMap(2)=(EmoteTag="TauntC",TauntSoundIndex=(4,12,13,23))
   TauntAnimSoundMap(3)=(EmoteTag="TauntD",TauntSoundIndex=(3,8,17))
   TauntAnimSoundMap(4)=(EmoteTag="TauntE",TauntSoundIndex=(7,10,11,18))
   TauntAnimSoundMap(5)=(EmoteTag="TauntF",TauntSoundIndex=(0,5,15,21))
   LocationSpeechOffset=1
   Name="Default__UTVoice_Lauren"
