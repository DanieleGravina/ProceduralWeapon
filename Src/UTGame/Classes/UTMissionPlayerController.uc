...
function SetMissionView(name BoneName, name MapGlobe, float MapDist)
{
	...
	{
		LogInternal("Attempting to view a globe that doesn't exist"@MapGlobe$"."$BoneName);
	}
}
...
{
   bInitialSet=True
   CameraInTransitionDuration=2.000000
   Tanmod=32.000000
   CameraPullBackDistance=400.000000
   ...
   Name="Default__UTMissionPlayerController"
