...
event PostInitialize()
{
	...
	if (OnlineSub != None)
	{
		...
		{
			LogInternal("UTUIFrontEnd_Leaderboards::PostInitialize() - Stats Interface is None!");
		}
	}
	else
	{
		LogInternal("UTUIFrontEnd_Leaderboards::PostInitialize() - OnlineSub is None!");
	}
...
function OnToggleGameMode()
{
    ...
    LogInternal("UTUIFrontEnd_Leaderboards::OnToggleGameMode() - Moving to next game mode");
...
function OnToggleView()
{
	...
	LogInternal("UTUIFrontEnd_Leaderboards::OnToggleViewType() - Moving to next view type(player filter)");
	RefreshStats();
}
...
function OnToggleMatchType()
{
    ...
    LogInternal("UTUIFrontEnd_Leaderboards::OnToggleMatchType() - Moving to next match type"@MatchType);
	RefreshStats();
}
...
function RefreshStats()
{
	...
	// Issue the stats.
	LogInternal("UTUIFrontEnd_Leaderboards::RefreshStats() - Refreshing leaderboard.");
	StatsDataStore.ResetToDefaultRead();
...
{
	LogInternal("UTUIFrontEnd_Leaderboards::OnStatsReadComplete() - Stats read completed, bWasSuccessful: " $ bWasSuccessful);
...
defaultproperties
{
   ...
   Name="Default__UTUIFrontEnd_Leaderboards"
