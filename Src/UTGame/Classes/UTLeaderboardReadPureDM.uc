...
defaultproperties
{
   ...
   ColumnMappings(2)=(Id=41,Name="EVENT_BULLSEYE",ColumnName="Bersaglio")
   ...
   ColumnMappings(6)=(Id=6,Name="EVENT_FIRSTBLOOD",ColumnName="Primi Attacchi")
   ColumnMappings(7)=(Id=42,Name="EVENT_HIJACKED",ColumnName="Dirottamenti veicolo")
   ColumnMappings(8)=(Id=44,Name="EVENT_RANOVERKILLS",ColumnName="Uccisioni da veicolo")
   ColumnMappings(9)=(Id=45,Name="EVENT_RANOVERDEATHS",ColumnName="Ucciso da veicolo")
   ...
   ColumnMappings(16)=(Id=31,Name="PICKUPS_BERSERK",ColumnName="Berserk")
   ColumnMappings(17)=(Id=34,Name="PICKUPS_INVISIBILITY",ColumnName="Invisibilità")
   ColumnMappings(18)=(Id=35,Name="PICKUPS_INVULNERABILITY",ColumnName="Invulnerabilità")
   ColumnMappings(19)=(Id=7,Name="PICKUPS_JUMPBOOTS",ColumnName="Stivali Anti-Gravità")
   ColumnMappings(20)=(Id=43,Name="PICKUPS_SHIELDBELT",ColumnName="Elettrocintura")
   ColumnMappings(21)=(Id=36,Name="PICKUPS_UDAMAGE",ColumnName="UDamage")
   ...
   ColumnMappings(24)=(Id=37,Name="POWERUPTIME_BERSERK",ColumnName="Tempo Berserk")
   ColumnMappings(25)=(Id=38,Name="POWERUPTIME_INVISIBILITY",ColumnName="Tempo invisibilità")
   ColumnMappings(26)=(Id=39,Name="POWERUPTIME_INVULNERABILITY",ColumnName="Tempo invulnerabilità")
   ColumnMappings(27)=(Id=40,Name="POWERUPTIME_UDAMAGE",ColumnName="Tempo danno")
   ...
   ColumnMappings(57)=(Id=999,Name="ELO",ColumnName="Teschi Collezionati")
   ...
   Name="Default__UTLeaderboardReadPureDM"
