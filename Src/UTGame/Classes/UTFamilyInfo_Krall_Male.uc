...
defaultproperties
{
   ...
   SkeletonBurnOutMaterials(0)=MaterialInstanceTimeVarying'CH_Skeletons.Materials.MITV_CH_Skeletons_Krall_01_BO'
   SkeletonBurnOutMaterials(1)=MaterialInstanceTimeVarying'CH_Skeletons.Materials.MITV_CH_Skeletons_Krall_01_BO'
   DrivingDrawScale=0.850000
   Name="Default__UTFamilyInfo_Krall_Male"
   ObjectArchetype=UTFamilyInfo_Krall'UTGame.Default__UTFamilyInfo_Krall'
}
