...
defaultproperties
{
   CoinCountPosition=(X=0.500000,Y=0.000000)
   PotString="Contenitore"
   RogueString="Mascalzone"
   FreelanceString="Da solo"
   DaggerWidth=16
   DaggerHeight=28
   DaggerSpacing=7.000000
   SilverDaggerOffset=10.000000
   NameYPadding=6.000000
   DaggerYPadding=3.600000
   TeammateSpacing=-3.000000
   NameFontSize=1
   YFudgeValue=10
   PotValPadding=7
   DaggerTexCoords=(U=262.000000,V=53.000000,UL=16.000000,VL=28.000000)
   Name="Default__UTBetrayalHUD"
