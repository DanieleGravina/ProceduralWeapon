...
{
   AvailableMines=15
   DetectionRange=1500.000000
   SpawnOffset(1)=(X=0.000000,Y=-12.000000,Z=0.000000)
   SpawnOffset(2)=(X=0.000000,Y=12.000000,Z=0.000000)
   SpawnOffset(3)=(X=12.000000,Y=0.000000,Z=0.000000)
   SpawnOffset(4)=(X=-12.000000,Y=0.000000,Z=0.000000)
   ...
   Name="Default__UTSpiderMineTrap"
