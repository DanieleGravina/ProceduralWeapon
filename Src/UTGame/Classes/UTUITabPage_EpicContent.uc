...
event PostInitialize()
{
	...
	if (OnlineSub != None)
	{
		...
		{
			LogInternal("UTUITabPage_EpicContent::PostInitialize() - Couldn't find news interface!");
		}
	}
}
...
{
	LogInternal("UTUITabPage_EpicContent::ReadContent() - Reading content from the web...");
...
{
	LogInternal("UTUITabPage_EpicContent::OnReadContentAnnouncementsCompleted() - bWasSuccessful: "$bWasSuccessful);
