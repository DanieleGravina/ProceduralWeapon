...
function StartLoadingPackage(string FamilyID)
{
	if(IsGame())
	{
		LogInternal("UTUIFrontEnd_CharacterCustomization::StartLoadingPackage() - Starting to load character part package (" $ Character.CharData.FamilyID $ ")");
...
event UpdateLoadingPackage()
{
	...
	{
		LogInternal("UTUIFrontEnd_CharacterCustomization::UpdateLoadingPackage() - Pending character part package done loading (" $ Character.CharData.FamilyID $ ")");
...
function LoadCharacterData()
{
	...
	{
		LogInternal("UTUIFrontEnd_CharacterCustomization::LoadCharacterData() - Loaded Profile Data, Value string: " $ CharacterDataStr);
	...
	if(bUseDefault)
	{
		LogInternal("UTUIFrontEnd_CharacterCustomization::LoadCharacterData() - Unable to load profile data, using default.");
...
function SaveCharacterData()
{
	...
	LogInternal("UTUIFrontEnd_CharacterCustomization::SaveCharacterData() - Saving Profile Data, Value string: " $ CharacterDataStr);
	...
	{
		LogInternal("UTUIFrontEnd_SettingsPanels::OnBack() - Saving player profile.");
	...
	{
		LogInternal("UTUIFrontEnd_SettingsPanels::OnBack() - Unable to locate OnlinePlayerData datastore for saving out profile.");
		OnSaveProfileCompleted();
	}
