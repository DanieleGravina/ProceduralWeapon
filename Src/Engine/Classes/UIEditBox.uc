...
{
   DataSource=
   Begin Object Class=UIComp_DrawStringEditbox Name=EditboxStringRenderer ObjName=EditboxStringRenderer Archetype=UIComp_DrawStringEditbox'Engine.Default__UIComp_DrawStringEditbox'
      StringCaret=(bDisplayCaret=True)
      bIgnoreMarkup=True
      Name="EditboxStringRenderer"
      ObjectArchetype=UIComp_DrawStringEditbox'Engine.Default__UIComp_DrawStringEditbox'
   End Object
   StringRenderComponent=EditboxStringRenderer
   Begin Object Class=UIComp_DrawImage Name=EditboxBackgroundTemplate ObjName=EditboxBackgroundTemplate Archetype=UIComp_DrawImage'Engine.Default__UIComp_DrawImage'
      StyleResolverTag="Background Image Style"
      Name="EditboxBackgroundTemplate"
