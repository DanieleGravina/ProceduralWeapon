...
event LocalPlayer CreatePlayer(int ControllerId, out string OutError, bool bSpawnActor)
{
	...
	LogInternal("Creating new player with ControllerId" @ ControllerId,'PlayerManagement');
	...
	{
		LogInternal("Successfully created new player with ControllerId" @ ControllerId $ ":" @ NewPlayer,'PlayerManagement');
	}
	return NewPlayer;
}
...
event bool RemovePlayer(LocalPlayer ExPlayer)
{
	...
	{
		LogInternal("Removing player" @ ExPlayer @ " with ControllerId" @ ExPlayer.ControllerId,'PlayerManagement');
		...
		LogInternal("Finished removing player " @ ExPlayer @ " with ControllerId" @ ExPlayer.ControllerId,'PlayerManagement');
