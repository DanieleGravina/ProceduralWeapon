...
{
   ImageDataSource=
   Begin Object Class=UIComp_DrawImage Name=ImageComponentTemplate ObjName=ImageComponentTemplate Archetype=UIComp_DrawImage'Engine.Default__UIComp_DrawImage'
      Name="ImageComponentTemplate"
   ...
   Position=(Value[2]=50.000000,Value[3]=50.000000,ScaleType[2]=EVALPOS_PixelOwner,ScaleType[3]=EVALPOS_PixelOwner)
