...
defaultproperties
{
   ...
   ValueDataSource=
   Begin Object Class=UIComp_DrawImage Name=CheckedImageTemplate ObjName=CheckedImageTemplate Archetype=UIComp_DrawImage'Engine.Default__UIComp_DrawImage'
      StyleResolverTag="Check Style"
      ImageStyle=(DefaultStyleTag="DefaultCheckbox")
      Name="CheckedImageTemplate"
