...
*/
			...
			{
				WarnInternal("OnlineSubsystem does not support the player interface. Can't retrieve clan mates for player ("$
					Player.ControllerId$")");
			}
		}
		else
		{
			WarnInternal("No OnlineSubsystem present. Can't retrieve clan mates for player ("$
				Player.ControllerId$")");
		}
	}
}
