...
defaultproperties
{
   VariableLinks(3)=(ExpectedType=Class'Engine.SeqVar_Int',LinkDesc="Old Index",PropertyName="PreviousIndex",bWriteable=True,MinVars=1,MaxVars=255)
   VariableLinks(4)=(ExpectedType=Class'Engine.SeqVar_Int',LinkDesc="New Index",PropertyName="CurrentIndex",bWriteable=True,MinVars=1,MaxVars=255)
   ObjName="List Index Changed"
   Name="Default__UIEvent_ListIndexChanged"
