...
final event EnableSetIndex()
{
	...
	{
		ScriptTrace();
		WarnInternal("EnableSetIndex called too many times on (" $ WidgetTag $ ")" @ Class.Name $ "'" $ PathName(Self) $ "'; resetting value back to 0.");
...
final event EnableValueChangeNotification()
{
	...
	{
		ScriptTrace();
		WarnInternal("EnableValueChangeNotification called too many times on (" $ WidgetTag $ ")" @ Class.Name $ "'" $ PathName(Self) $ "'; resetting value back to 0.");
...
defaultproperties
{
   RowHeight=(Value=16.000000)
   MinColumnSize=(Value=0.500000)
   ColumnWidth=(Value=100.000000)
   ColumnCount=1
   RowCount=4
   ...
   GlobalCellStyle(0)=(DefaultStyleTag="DefaultCellStyleNormal",RequiredStyleClass=Class'Engine.UIStyle_Combo')
   GlobalCellStyle(1)=(DefaultStyleTag="DefaultCellStyleActive",RequiredStyleClass=Class'Engine.UIStyle_Combo')
   GlobalCellStyle(2)=(DefaultStyleTag="DefaultCellStyleSelected",RequiredStyleClass=Class'Engine.UIStyle_Combo')
   GlobalCellStyle(3)=(DefaultStyleTag="DefaultCellStyleHover",RequiredStyleClass=Class'Engine.UIStyle_Combo')
   ColumnHeaderStyle=(DefaultStyleTag="DefaultColumnHeaderStyle",RequiredStyleClass=Class'Engine.UIStyle_Combo')
   ColumnHeaderBackgroundStyle(0)=(RequiredStyleClass=Class'Engine.UIStyle_Image')
   ColumnHeaderBackgroundStyle(1)=(RequiredStyleClass=Class'Engine.UIStyle_Image')
   ColumnHeaderBackgroundStyle(2)=(RequiredStyleClass=Class'Engine.UIStyle_Image')
   ItemOverlayStyle(0)=(DefaultStyleTag="ListItemBackgroundNormalStyle",RequiredStyleClass=Class'Engine.UIStyle_Image')
   ItemOverlayStyle(1)=(DefaultStyleTag="ListItemBackgroundActiveStyle",RequiredStyleClass=Class'Engine.UIStyle_Image')
   ItemOverlayStyle(2)=(DefaultStyleTag="ListItemBackgroundSelectedStyle",RequiredStyleClass=Class'Engine.UIStyle_Image')
   ItemOverlayStyle(3)=(DefaultStyleTag="ListItemBackgroundHoverStyle",RequiredStyleClass=Class'Engine.UIStyle_Image')
   ...
   Begin Object Class=UIComp_ListPresenter Name=ListPresentationComponent ObjName=ListPresentationComponent Archetype=UIComp_ListPresenter'Engine.Default__UIComp_ListPresenter'
      ...
      Name="ListPresentationComponent"
