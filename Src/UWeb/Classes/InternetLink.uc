...
defaultproperties
{
   ...
   Begin Object Class=SpriteComponent Name=Sprite ObjName=Sprite Archetype=SpriteComponent'Engine.Default__InternetInfo:Sprite'
      ObjectArchetype=SpriteComponent'Engine.Default__InternetInfo:Sprite'
   End Object
   Components(0)=Sprite
   Name="Default__InternetLink"
   ObjectArchetype=InternetInfo'Engine.Default__InternetInfo'
}
