...
function DelegateReturnValueAccessTest()
{
	...
	LogInternal(LocalStruct.InnerStructInt);
...
{
	LogInternal(Name$"::"$GetFuncName()@"BEFORE:"@"m_StructArray.Length:'"$m_StructArray.Length$"'");

	m_StructArray[3].InnerStructInt = 5;

	LogInternal(Name$"::"$GetFuncName()@"AFTER:"@"m_StructArray.Length:'"$m_StructArray.Length$"'");
}

defaultproperties
{
   m_OuterStruct=(OuterStruct_Float=50.000000,OuterStruct_NestedStruct=(InnerStructInt=1000))
   m_DerivedOuterStruct=(OuterStruct_StructArray=((InnerStructInt=1),(InnerStructInt=2)),OuterStruct_Float=100.000000,OuterStruct_NestedStruct=(InnerStructInt=2000))
   m_CtorStruct=(CtorStruct_String="DefaultValue")
   m_StructArray(0)=(InnerStructInt=10)
   m_StructArray(1)=(InnerStructInt=20)
   m_ConstStruct=(InnerStructInt=100)
   m_ConstStructDelegateProp=Default__Test0022_StructMemberAccess.ReturnMemberStruct
   Name="Default__Test0022_StructMemberAccess"
