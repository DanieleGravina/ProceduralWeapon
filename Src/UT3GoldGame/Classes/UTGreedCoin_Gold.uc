...
defaultproperties
{
   ...
   PickUpWaveForm=ForceFeedbackWaveform'UT3GoldGame.Default__UTGreedCoin_Gold:ForceFeedbackWaveformPickUp'
   SkullColor=(R=32.000000,G=16.000000,B=4.000000,A=1.000000)
   ...
   Name="Default__UTGreedCoin_Gold"
