...
defaultproperties
{
   ...
   DefaultImpactEffect=(Sound=SoundCue'A_Weapon_ShockRifle.Cue.A_Weapon_SR_AltFireImpactCue',ParticleTemplate=ParticleSystem'VH_Hellbender.Effects.P_VH_Hellbender_PrimeImpact')
   bFastRepeater=True
   ...
   AimingHelpRadius(0)=0.000000
   AimingHelpRadius(1)=0.000000
   WeaponFireTypes(0)=EWFT_Projectile
   FireInterval(0)=0.400000
   FireInterval(1)=0.750000
   ...
   Name="Default__UTVWeap_ShockTurretBase"
