...
defaultproperties
{
   ...
   Seats(0)=(GunClass=Class'UTGameContent.UTVWeap_TurretShock',GunSocket=("GunLeft","GunRight"),GunPivotPoints=("Seat"),WeaponEffects=((SocketName="GunLeft",Offset=(X=-35.000000,Y=-3.000000,Z=0.000000),Scale3D=(X=4.000000,Y=4.500000,Z=4.500000)),(SocketName="GunRight",Offset=(X=-35.000000,Y=-3.000000,Z=0.000000),Scale3D=(X=4.000000,Y=4.500000,Z=4.500000))),TurretControls=("PitchControl","LeftYawControl","RightYawControl"),CameraTag="CameraViewSocket",CameraBaseOffset=(X=0.000000,Y=0.000000,Z=50.000000),CameraOffset=-120.000000,CameraEyeHeight=5.000000,bSeatVisible=True,SeatBone="Seat",SeatOffset=(X=36.000000,Y=0.000000,Z=23.000000),SeatRotation=(Pitch=1820,Yaw=0,Roll=0),DriverDamageMult=0.400000,SeatMotionAudio=TurretTwistSound)
   VehicleEffects(1)=(EffectStartTag="TurretFireLeft",bRestartRunning=True,EffectTemplate=ParticleSystem'VH_Leviathan.Effects.P_VH_Leviathan_TurretShockMF',EffectSocket="GunLeft")
   VehicleEffects(2)=(EffectStartTag="TurretFireRight",bRestartRunning=True,EffectTemplate=ParticleSystem'VH_Leviathan.Effects.P_VH_Leviathan_TurretShockMF',EffectSocket="GunRight")
   ...
   End Object
   StayUprightConstraintSetup=RB_StayUprightSetup'UTGameContent.Default__UTVehicle_ShieldedTurret_Shock:MyStayUprightSetup'
   ...
   End Object
   StayUprightConstraintInstance=RB_ConstraintInstance'UTGameContent.Default__UTVehicle_ShieldedTurret_Shock:MyStayUprightConstraintInstance'
   ...
   Name="Default__UTVehicle_ShieldedTurret_Shock"
