...
def TuningSingleWeapon(iter = 0):
    ...
    #plt.plot([i for i in range(50)], [pop[i].fitness.values[0] for i in range(50)])
    #plt.plot([i for i in range(50)], [pop[i].fitness.values[1] for i in range(50)], "r")
