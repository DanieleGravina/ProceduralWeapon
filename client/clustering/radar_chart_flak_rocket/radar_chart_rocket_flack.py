...
def get_data():
    ...
    data.update({'Rocket Launcher' : [normalize(postProcess([1.05,  0.1,     30,      1,     8, 1350, 100,       42,      0, 220]))]})

    data.update({'Flak' : [normalize(postProcess([1.1,   0.1,   30,      9,     2, 3500,  18,       20,      0, 0]))]})
