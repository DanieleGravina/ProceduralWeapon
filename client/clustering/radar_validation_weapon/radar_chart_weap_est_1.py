...
def get_data():
    ...
    data.update({'Weapon Red' : [normalize(postProcess([0.52,  0.05,     640.29,      8.03,     24.93, 6983.09, 58.66,       4.31,      -229.15, 22.75]))]})

    data.update({'Weapon Blue' : [normalize(postProcess([0.73,   0.15,   390.08,      5.02,     58.17, 9585.92,  51.48,       48.75,      123.53, 18.66]))]})
...
def draw_radar():
    ...
    #plt.show()
    plt.savefig("Blue_vs_Red.png", bbox_inches='tight', dpi = 200)
    plt.close()
