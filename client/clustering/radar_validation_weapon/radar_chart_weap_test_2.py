...
def get_data():
    ...
    data.update({'Weapon Blue' : [normalize(postProcess([0.57,  0.32,     822.42,      8.56,     96.95, 5746, 99.23,       81.87,      -76.78, 15.19]))]})

    data.update({'Weapon Red' : [normalize(postProcess([0.18,   0.23,   899.97,      3.92,     80.97, 987.79,  70.8,       87.24,      -5.64, 41.34]))]})
