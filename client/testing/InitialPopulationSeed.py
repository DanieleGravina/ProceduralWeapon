...
Weapons += [[1,   0,      100,      1,     2, 1000,  10,       20,      0, 0]]

Weapons += [[1.1,   0.1,   30,      1,     2, 3500,  18,       20,      0, 0]]

#Enforcer
Weapons += [[0.36,  0.03, 100,      1,     2, 10000, 10,       20,      0, 0]]

#Sniper
Weapons += [[1.33,  0,     40,      1,     10, 20000, 50,       20,      0, 0]]

#Rocket launcher
Weapons += [[1.05,  0.5,     30,      1,     8, 1350, 100,       42,      -1, 0]]

#Avril
Weapons += [[4,     0,     15,      1,       8, 500,  100,         20,      -2, 0]]

#Instagib
Weapons += [[1.1,     0,     1,      0,     8, 20000,  1000,         20,      0, 0]]
