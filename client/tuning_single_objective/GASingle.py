...
if DEBUG :
    ...
    path = "single_objective_100_pop_50_iter_simulated_binary_final_" + str(iter)
...
def main():
    ...
    line_down, = plt.plot(gen, fit_avg, 'r--', label="Average")
    line_up, = plt.plot(gen, fit_max, 'b-', label="Max")
    plt.ylim(0, 3)
